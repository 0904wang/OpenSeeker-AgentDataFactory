...
CUDA_VISIBLE_DEVICES=0,1,2,5 PYTHONNOUSERSITE=1 \
  llamafactory-cli train configs/llamafactory/qwen3_8b_lora_sft_2p4k_mixed_v3_v4_v5blind_v6blindtoolchoice_restore_a0.yaml \
  2>&1 | tee /data/wzl/OpenSeeker-AgentDataFactory/logs/20260701-restore-a0-qwen3-8b-sft-2p4k-gpu0125.log
